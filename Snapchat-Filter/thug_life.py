...
hair1_ori = cv2.imread('hair1.png', -1)
...
while 1:
    ...
    for x, y, w, h in faces:
        if h > 0 and w > 0:
            ...
            hair1_symin = int(y + 1.5 * h / 5)
            hair1_symax = int(y + 7 * h / 5)
            sh_hair1 = hair1_symax - hair1_symin
            ...
            face_hair1_roi_color = img[hair1_symin:hair1_symax, x:x + w]
            ...
            hair1 = cv2.resize(hair1_ori, (w, sh_hair1), interpolation=cv2.INTER_CUBIC)
            mustache = cv2.resize(mus_ori, (w, sh_mus), interpolation=cv2.INTER_CUBIC)

            transparentOverlay(face_glass_roi_color, specs)
            transparentOverlay(face_hair1_roi_color, hair1, pos=(0, -30))
            # transparentOverlay(face_hair1_roi_color, hair1, pos=(0, 0))
