...
image = r"C:\Users\omarh\Desktop\Amanda Seyfried (2).jpg"
...
def main_GUI():
    ...
    # frame = resized
    h,w,o = img.shape
    frame = cv2.resize(img, (h*2, w*2), interpolation=cv2.INTER_AREA)
    ...
    for face_loc, name in zip(face_locations, face_names):
        ...
        try:
            cv2.putText(frame, name.split('(')[0], (x1, y1 - 10), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 200), 2)  # to add text into an image
        except:
            1
